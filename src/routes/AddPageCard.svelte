    ...
    <div class="card">
      <center>
        ...
        <center id="c2" style="display: {c2Visible};">
          ...
          <h2>Your Contact</h2>
          <br>
          <input id="i2" class="form-control input-sm" style="border-width: medium; border-color: black; width: 80%;" placeholder="+91 xxxxxxxxxx">
          <h2>Book's Price</h2>
          <br>
          <input id="i3" class="form-control input-sm" style="border-width: medium; border-color: black; width: 80%;" placeholder="Rs. 500">
          <br>
        </center>  
      </div>
</div>
